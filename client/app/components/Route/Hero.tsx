...
const Hero: FC<Props> = (props) => {
  return (
    <div className="w-full 1000px:flex items-center">
      <div className="absolute top-[100px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[600px] h-[50vh] w-[50vh] hero_animation rounded-[50%] 1100px:left-8 1500px:left-14"></div>
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        ...
        <p className="dark:text-[#edfff4] text-[#000000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]">
          We have 20k+ Online courses & 500K+ Online registered student. Find
        ...
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center">
          ...
          <p className="font-Josefin dark:text-[#edfff4] text-[#000000b3] 1000px:pl-3 text-[18px] font-[600]">
            ...
            <Link
              href={"/courses"}
              className="dark:text-[#46e256] text-[#46e256]"
            >
              View Courses
            </Link>{" "}
          </p>
