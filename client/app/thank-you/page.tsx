                  ...
                  <div className="w-[80%]">
                    <div className="lg:col-start-2">
                      ...
                      <p className="mt-2 text-base text-muted-foreground">
                        Este curso sera suyo de por vida, recuerde unirse a
                        Discord para formar parte de la comunidad que se ayuda
                        entre si a alcanzar sus objetivos. Nos vemos en el
                        curso.
                      </p>
                    </div>
                  </div>
